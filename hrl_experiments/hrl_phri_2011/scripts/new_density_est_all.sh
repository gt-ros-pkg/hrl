...
rosrun hrl_phri_2011 density_estimation $dir/sub1_head_stitched_gray.bag $ccargs ${dir}/${tools[$1]}_${places[$2]}_${functions[$3]}_density_est_new.bag _target_force:=0.5 _pilot_ph:=$4 _pilot_fh:=0.1 _percent_trim:=$5 _use_min:=1
