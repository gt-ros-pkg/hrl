...
from behavior_manager import BehaviorManagerClient, clear_behavior_manager, BMPriorities
...
def main():
    ...
    p_low = BMPriorities.LOW
    p_med = BMPriorities.MEDIUM
    p_high = BMPriorities.HIGH
