#! /usr/bin/python
import roslib
roslib.load_manifest('approach_table')
...
from approach_table.srv import ApproachSrv
from approach_table.msg import ApproachAction, ApproachResult, ApproachGoal
