...
def smooth(x, window_len=10, window='hanning'):
    ...
    # Hai and Advait: removed things we don't understand. (Feb 26, 2010)
    # this code is mirroring the first and last window_len elements.
    #s=np.r_[2*x[0]-x[window_len:1:-1], x, 2*x[-1]-x[-1:-window_len:-1]]
    # and added in what we do understand
    s = x
