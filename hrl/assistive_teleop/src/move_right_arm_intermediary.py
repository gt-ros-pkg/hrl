...
class MoveArmIntermediary():
    ...
    def __init__(self):
        ...
        self.move_right_arm_client = actionlib.SimpleActionClient('move_right_arm', move_arm_msgs.msg.MoveArmAction)
    #    self.right_arm_traj_client = actionlib.SimpleActionClient('r_arm_controller/joint_trajectory_action', JointTrajectoryAction)
        ...
        try:
            ...
            if ik_goal.error_code.val == 1:
                ...
                if (self.try_per >= 0.01):
                    self.wt_log_out.publish(data="Small Move Goal Out of Reach: Trying to move part of the  way")
                    goal_pos = msg.pose.position
    ...
    def send_joint_angles(self, goal):
        ...
        #self.right_arm_traj_client.send_goal(joints_goal)
        #self.right_arm_traj_client.wait_for_result(rospy.Duration(5))
