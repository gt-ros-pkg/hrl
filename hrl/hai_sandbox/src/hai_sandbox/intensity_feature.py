...
class IntensityCloudFeatureExtractor:
    ...
    def _subsample(self):
        ...
        #self.tree_pc_sub_samp_bl = sp.KDTree(np.array(self.pc_sub_samp_bl.T))
    ...
    def _sample_points(self):
        ...
        return self.pc_sub_samp_bl[:, pt_indices]



    def extract_vectorized_features(self):
        #locs2d are projection of 3ds point at center of feature into image
        #locs3d are 3d points in scan that are closest to sampled points
        return xs, locs2d, feature_locs3d
