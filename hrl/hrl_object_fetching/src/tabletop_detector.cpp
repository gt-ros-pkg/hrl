...
namespace hrl_object_fetching {
    ...
    void TabletopDetector::pcCallback(sensor_msgs::PointCloud2::ConstPtr pc_msg) {
        ...
        float stddev = 256/(maxz-minz) * 0.005;
        ...
        //cvMorphologyEx(&height_img_thresh, &height_img_thresh, NULL, element, CV_MOP_CLOSE);
        ...
        //cv::Sobel(table_blob, table_blob, CV_8U, 0, 1, 1);
